...
const EstimatedFee: React.FC<IProps> = ({ estimateBTCGas, estimateTCGas, classNames }: IProps): React.ReactElement => {
  return (
        ...
        <div className="est-fee-options">
          ...
          >
            ...
            <p className='est-fee-item-value'>
              {estimateBTCGas ? `~ ${formatBTCPrice(estimateBTCGas)} BTC` : <EllipsisLoading />}
            </p>
          </div>
          <div
            className={`est-fee-item`}
          >
            ...
            <p className='est-fee-item-value'>
              {estimateTCGas ? `~ ${formatEthPrice(estimateTCGas)} TC` : <EllipsisLoading />}
            </p>
          </div>
        </div>
      </div>
