...
export const TC_WEB_WALLET_URL: string =
  process.env.NEXT_PUBLIC_TC_WEB_WALLET_URL!;
export const TC_WALLET_CONNECT_URL =
  process.env.NEXT_PUBLIC_WALLET_CONNECT_URL!;
